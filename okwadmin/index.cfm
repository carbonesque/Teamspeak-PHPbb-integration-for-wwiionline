...
<table align="center" valign="middle" width="700" height="440" border="0" cellpadding="2" cellspacing="0" bgcolor="#000000">
  <tr>
    <td width="700" height="440">
	  <table bgcolor="#dddddd">
        <tr>
          <td  width="400" height="440" valign="top" bgcolor="#dddddd">
		    <iframe src="http://okw.wwiiol.net/post/info.php?detail=209.97.196.74&detailport=8767" scrolling="auto" frameborder="0" width="450" height="440"></iframe>
          </td>
          <td width="1" height="440" bgcolor="#bbbbbb"></td>
          <td width="300" height="440" valign="top" bgcolor="#dddddd" class="size9grey">Logged in as: 
			...
			<cfif #userinfo.group_admin# GT '0'><!--- User is an admin --->
			  ...
			  <cfif #userinfo.group_admin# GT '1'> <!--- user is okw branch command --->
