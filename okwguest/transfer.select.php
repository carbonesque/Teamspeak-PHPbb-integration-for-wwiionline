	 ...
	 $grouprank = $row["group_rank"];
 	 $groupkey = $row["group_key"];
		...
		if ($grouprank < $attachrank) 		// group is a squad make it orange
			echo " <span class=\"squadorange\"><a href=\"http://okw.wwiiol.net:8500/okwguest/account_transfer.cfm?group_key=$groupkey\" class=\"squadorange\">$groupname</a></span>";
		if ($grouprank == $attachrank) // Group is a brigade show in blue
			echo "   <span class=\"darkblue\"><a href=\"http://okw.wwiiol.net:8500/okwguest/account_transfer.cfm?group_key=$groupkey\" class=\"darkblue\">$groupname</a></span>";
